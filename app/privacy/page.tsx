  ...
  return (
    <main className="min-h-dvh bg-white px-5 py-10 text-slate-900" style={{ colorScheme: "light" }}>
      <article className="mx-auto max-w-2xl space-y-7 text-[15px] leading-7">
        ...
        <section><h2 className="text-lg font-semibold">Questions and answers</h2><p>Your questions, including images you upload, are sent to our AI and retrieval services to produce an answer. We may cache text answers to improve response speed. Padhle saves your conversations to your account so you can open them later. Saved history retains message text and source citations; uploaded image files are not kept in chat history.</p></section>
